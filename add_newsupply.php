...
<html> 
<head> 
<title>New Supply Management</title>
...
<h3>Add the details of new supply recieved to manage inventory of the supermarket
<br> Add number of products sold for the day according to ID wise</h3> 
<form method="POST" action="conn5.php">

<br> ID <br><input type="number" name="ID">
<br> SID <br><input type="number" name="SID">
<br>Product Name<br>
...
<br> NO OF PRODUCTS<br><input type="number" name="PNO">
